...
METRICS = [
    ...
    ("City home clashes (same day)", lambda r: r.city_clash_count,               "SC7 same-day"),
    ("City clashes (4-day window)", lambda r: r.city_weekend_clash_count,       "SC7 widened target = 0"),
    ...
    ("5-match pattern violations",lambda r: r.five_match_pattern_violations,    "SC13 target = 0"),
    ("Season boundary violations",lambda r: r.season_boundary_violations,       "SC14 target = 0"),
    ("BoxDay/NYD pair violations",lambda r: r.boxing_day_nyd_violations,        "SC15 target = 0"),
