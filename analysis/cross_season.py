...
METRICS = [
    ...
    ("City home clashes",         lambda r: r.city_clash_count,                 "HC2 target = 0"),
    ...
    ("Teams >3 consec. away",     lambda r: len(r.teams_over_3_away),           "SC1 violations"),
    ("Teams >3 consec. home",     lambda r: len(r.teams_over_3_home),           "SC2 violations"),
